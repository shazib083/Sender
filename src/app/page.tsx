...
export default function LandingPage() {
  return (
    <main className="min-h-screen overflow-x-hidden">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-surface-300/50 bg-surface/70 backdrop-blur-xl">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center pt-16">
        ...
        <div className="relative max-w-4xl">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-400 leading-relaxed">
            Sender is the fastest way to batch-distribute USDC, EURC, and native tokens
            on Arc Testnet. Upload a CSV, review, and execute — gas-optimized in a single transaction.
          </p>
      ...
      {/* Footer */}
      <footer className="border-t border-surface-300 py-8 px-6 text-center text-sm text-gray-600">
...
const FEATURES = [
  {
    ...
    description:
      "MultiSend smart contract groups all transfers into one transaction, saving up to 60% gas vs sequential sends.",
  },
  {
    icon: Globe,
    title: "Multi-token support",
    description:
      "Send USDC, EURC, and native ARC tokens simultaneously in the same batch — mix and match freely.",
  },
  {
    icon: Shield,
    title: "Pre-flight validation",
    description:
      "Every address and amount is validated before execution. Insufficient balances are flagged before any gas is spent.",
  },
  {
    icon: BarChart3,
    title: "CSV upload & paste",
    description:
      "Import hundreds of recipients via CSV upload, paste, or download our Excel template. Bulk operations made simple.",
  },
  {
    icon: ArrowRight,
    title: "Transaction history",
    description:
      "Full audit trail of every batch. Export reports to Excel for accounting and compliance purposes.",
  },
  {
    icon: Globe,
    title: "Address book",
    description:
      "Save frequently-used wallet addresses with labels. Quickly recall them when building your next batch.",
  },
];
